            ...
            <div className="inicio-wrapper">
                ...
                <section className="section-padding">
                    ...
                    <div className="bento-grid">
                        <Link to="/catalogo" className="bento-item bento-main btn-hover-grow">
                            <div className="bento-content">
                                <h3>Ver Todo el Stock</h3>
                                <p>Más de 100 vehículos revisados</p>
                            </div>
                        </Link>
                        <Link to="/catalogo" className="bento-item bento-suv btn-hover-grow">
                            <div className="bento-content">
                                <h3>Gama SUV</h3>
                            </div>
                        </Link>
                        <Link to="/catalogo" className="bento-item bento-electric btn-hover-grow">
                            <div className="bento-content">
